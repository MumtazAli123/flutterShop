...
class TelenorTopUpScreen extends StatefulWidget {
  const TelenorTopUpScreen({Key? key}) : super(key: key);

  @override
  State<TelenorTopUpScreen> createState() => _TelenorTopUpScreenState();
}

class _TelenorTopUpScreenState extends State<TelenorTopUpScreen> with SingleTickerProviderStateMixin{
